...
urlpatterns = [
	...
	url(r'^detallevtaxsocio/(?P<idproveedor>[0-9]{1,8})/(?P<fechainicial>[\w\-]+)/(?P<fechafinal>[\w\-]+)/(?P<sucursalinicial>[0-9]{1,8})/(?P<sucursalfinal>[0-9]{1,8})/(?P<asociadono>[0-9]{1,8})/$',views.detallevtaxsocio,name='detallevtaxsocio'),
	...
	url(r'^vtaneta_socio_gral/$',views.vtaneta_socio_gral,name='vtaneta_socio_gral'),
	url(r'^vtaneta_socio_proveedor_gral/(?P<fechainicial>[\w\-]+)/(?P<fechafinal>[\w\-]+)/(?P<asociadoini>[0-9]{1,8})/(?P<asociadofin>[0-9]{1,8})/$',views.vtaneta_socio_proveedor_gral,name='vtaneta_socio_proveedor_gral'),
