      ...
      $('#id_proveedor_rpte_cotejo').change(function(){ //1
        ...
        $.ajax({ //2
          ...
          success: function(data){ //3
                            ...
                            tableData += "<tr><th>id</th><th>Referencia</th><th>Fecha Colocacion</th><th>Hora Colocacion</th><th>Tot. Articulos</th><th>Importe</th><th>Almacen</th></tr>"; // Dibuja encab
                            ...
                            $('tbody').append( //4
                                $.each(data, function(key,value){ //5
                                    ...
                                    tableData += '<td>' +value['id']+'</td>'; // link id para modificar.
                                     ...
                                     tableData += '<td>' + value['FechaColocacion'] + '</td>';
                                     tableData += '<td>' + value['HoraColocacion'] + '</td>';
