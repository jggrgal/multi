			...
			if form.is_valid():
				...
				if numpedido != 0:
					...
					if socionum != 0:
						...
						if  status == 'Todos':
							cursor.execute("SELECT l.pedido,l.productono,l.catalogo,l.precio,l.status,l.nolinea,h.asociadono,psf.fechamvto,h.pedidono,h.fechaultimamodificacion,a.codigoarticulo,a.catalogo,a.idmarca,a.idestilo,a.idcolor,a.talla,l.FechaTentativallegada,l.FechaMaximaEntrega,l.Observaciones,concat(aso.nombre,' ',aso.appaterno,' ',aso.apmaterno) as socionomb from pedidoslines l inner join pedidosheader h inner join articulo a on (l.pedido=h.pedidono and l.productono=a.codigoarticulo and l.catalogo=a.catalogo) INNER JOIN asociado aso on (h.asociadono=aso.asociadono) inner join pedidos_status_fechas psf on (l.empresano=psf.empresano and l.pedido=psf.pedido and l.productono=psf.productono and l.catalogo=psf.catalogo and l.nolinea=psf.nolinea) where h.empresano = 1 and h.idsucursal=%s and h.asociadono=%s and  psf.fechamvto>=%s and psf.fechamvto<=%s and l.status=psf.status ORDER BY h.pedidono DESC;", (sucursal_activa,socionum,fechainicial,fechafinal))
						...
						if estiloalt.strip() == '':
							...
							cursor.execute("SELECT l.pedido,l.productono,l.catalogo,l.precio,l.status,l.nolinea,h.asociadono,psf.fechamvto,h.pedidono,h.fechaultimamodificacion,a.codigoarticulo,a.catalogo,a.idmarca,a.idestilo,a.idcolor,a.talla,l.FechaTentativallegada,l.FechaMaximaEntrega,l.Observaciones,concat(aso.nombre,' ',aso.appaterno,' ',aso.apmaterno) as socionomb from pedidoslines l inner join pedidosheader h inner join articulo a on (l.pedido=h.pedidono and l.productono=a.codigoarticulo and l.catalogo=a.catalogo)  INNER JOIN asociado aso on (h.asociadono=aso.asociadono) inner join pedidos_status_fechas psf on (l.empresano=psf.empresano and l.pedido=psf.pedido and l.productono=psf.productono and l.catalogo=psf.catalogo and l.nolinea=psf.nolinea) where h.empresano = 1 and h.idsucursal=%s and l.status=%s and psf.fechamvto>=%s and psf.fechamvto<=%s and l.status=psf.status ORDER BY h.pedidono DESC;", (sucursal_activa,status,fechainicial,fechafinal))
						else:
							if status != 'Todos':
								cursor.execute("SELECT l.pedido,l.productono,l.catalogo,l.precio,l.status,l.nolinea,h.asociadono,psf.fechamvto,h.pedidono,h.fechaultimamodificacion,a.codigoarticulo,a.catalogo,a.idmarca,a.idestilo,a.idcolor,a.talla,l.FechaTentativallegada,l.FechaMaximaEntrega,l.Observaciones,concat(aso.nombre,' ',aso.appaterno,' ',aso.apmaterno) as socionomb from pedidoslines l inner join pedidosheader h inner join articulo a on (l.pedido=h.pedidono and l.productono=a.codigoarticulo and l.catalogo=a.catalogo)  INNER JOIN asociado aso on (h.asociadono=aso.asociadono) inner join pedidos_status_fechas psf on (l.empresano=psf.empresano and l.pedido=psf.pedido and l.productono=psf.productono and l.catalogo=psf.catalogo and l.nolinea=psf.nolinea) where h.empresano = 1 and h.idsucursal=%s and l.status=%s and a.idestilo=%s and psf.fechamvto>=%s and psf.fechamvto<=%s and l.status=psf.status ORDER BY h.pedidono DESC;", (sucursal_activa,status,estiloalt,fechainicial,fechafinal))
							else:
								cursor.execute("SELECT l.pedido,l.productono,l.catalogo,l.precio,l.status,l.nolinea,h.asociadono,psf.fechamvto,h.pedidono,h.fechaultimamodificacion,a.codigoarticulo,a.catalogo,a.idmarca,a.idestilo,a.idcolor,a.talla,l.FechaTentativallegada,l.FechaMaximaEntrega,l.Observaciones,concat(aso.nombre,' ',aso.appaterno,' ',aso.apmaterno) as socionomb from pedidoslines l inner join pedidosheader h inner join articulo a on (l.pedido=h.pedidono and l.productono=a.codigoarticulo and l.catalogo=a.catalogo)  INNER JOIN asociado aso on (h.asociadono=aso.asociadono) inner join pedidos_status_fechas psf on (l.empresano=psf.empresano and l.pedido=psf.pedido and l.productono=psf.productono and l.catalogo=psf.catalogo and l.nolinea=psf.nolinea) where h.empresano = 1 and h.idsucursal=%s and a.idestilo=%s and psf.fechamvto>=%s and psf.fechamvto<=%s and psf.status=l.status ORDER BY h.pedidono DESC;", (sucursal_activa,estiloalt,fechainicial,fechafinal))
